...
def getfruityvice_data(this_fruit_choice):
      ...
      return fruityvice_normalized  # output to the screen as a table
...
try:
  ...
  if not fruit_choice:
      streamlit.error("Please selecct a fruit to get information.")
  else:
...
def insert_row_snowflake(new_fruit):
    with my_cnx.cursor()as my_cur:
         ...
         return "Thanks for adding " + new_fruit     ################ new?
